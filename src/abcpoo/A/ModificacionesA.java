 ...
 * @author RNS
 */
public class ModificacionesA extends javax.swing.JFrame {
     ...
     */
    public ModificacionesA(final JFrame p) {
        initComponents();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        // uno = new EmpleadoAsalariado(txtNombre.getText(),txtApellidos.getText(),txtNSS.getText(),Double.parseDouble(txtSalario.getText()));
        Integrantes.get(pos).setApellidos(txtApellidos.getText());
        Integrantes.get(pos).setNombre(txtNombre.getText());
        Integrantes.get(pos).setNss(txtNSS.getText());
        ((EmpleadoAsalariado)(Integrantes.get(pos))).setSalario(Double.parseDouble(txtSalario.getText()));
        try {
    ...
    private void txtNSSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtNSSMouseClicked
        // TODO add your handling code here:
         btnAceptar.setEnabled(false);
    }//GEN-LAST:event_txtNSSMouseClicked
        ...
        for (Object empleado : Array) {
            if (empleado instanceof EmpleadoAsalariado) {
                if (((EmpleadoAsalariado) (empleado)).getNss().equals(NSS)) {
                    ...
                    System.out.println("NSS no encontrado");
